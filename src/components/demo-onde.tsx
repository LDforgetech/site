    ...
    <div className="w-full h-screen bg-black relative overflow-hidden">
      {activeEffect === "mesh" && (
        <MeshGradient
          ...
          colors={["#0C0727", "#B740D1", "#AC36FF", "#0C0727"]}
          // colors={["#6101D6", "#0C0727", "#351ABA", "#AC36FF", "#B740D1"]}
          speed={speed * 0.4}
        />
      )}
      ...
      {/* <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-8 left-8 pointer-events-auto">Header</div>

        <div className="absolute bottom-8 left-8 pointer-events-auto">Effect Controls</div>

        <div className="absolute bottom-8 right-8 pointer-events-auto space-y-4">Parameter Controls</div>

        <div className="absolute top-8 right-8 pointer-events-auto">Status indicator</div>
      </div> */}
